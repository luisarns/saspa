...
//         console.log("index = "+keys.indexOf(","));
...
//         console.log("populateList("+v+")");
    	if(v==undefined || v==null) v=this.value;
//     	console.log("2. populateList("+v+")"); 
    	// uncheck everything
    	if(this.menu) {
